...
export default function LeaderboardReputations() {
    const [sortedUsers, setSortedUsers] = useState([]);
    const [hoveredIndex, setHoveredIndex] = useState(null);

    useEffect(() => {
        const users = [
            { id: 0, name: "mazinx", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', reputations: 1050 },
            { id: 1, name: "reno", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', reputations: 313000 },
            { id: 2, name: "yves", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', reputations: 3000000 },
            { id: 3, name: "ahmed", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', reputations: 10 },
            { id: 4, name: "ifk", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', reputations: 5 },
        ];

        const sorted = users.sort((a, b) => b.reputations - a.reputations).slice(0, 100);
                    ...
                    <div className="flex space-x-3">
                        <AnimatePresence mode="wait">
                            {hoveredIndex === index ? (
                                ...
                                >
                                    <AnimatedCounter value={user.reputations} />
                                </motion.span>
                            ) : (
                                <motion.span
                                    key="short"
