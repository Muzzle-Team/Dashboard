...
export default function LeaderboardXP() {
    ...
    useEffect(() => {
        const users = [
            { id: 0, name: "mazinx", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', xp: 1050 },
            { id: 1, name: "reno", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', xp: 313000 },
            { id: 2, name: "yves", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', xp: 3000000 },
            { id: 3, name: "ahmed", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', xp: 10 },
            { id: 4, name: "ifk", icon: 'https://cdn.discordapp.com/avatars/618078478755037185/22daa8cb1def381f4928b95ac0624679.png?size=1024', xp: 5 },
        ];

        const sorted = users.sort((a, b) => b.xp - a.xp).slice(0, 100);
